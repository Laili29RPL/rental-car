            ...
            <div class="card-body">
                <ul class="list-group">
                    <?php
                        ...
                        $sql ="select sewa.*, pelanggan.*, karyawan.*, pengembalian_mobil.id_pengembalian, pengembalian_mobil.tgl_kembali
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="row">
                                <div class="col-lg-9 col-md-10">
                                    <small class="text-info">List pengembalian_mobil</small>
                                        <ul>
                                        <?php
